...
export function LoginForm() {
  ...
  return (
    <div className=" w-full flex items-center justify-center bg-slate-100 dark:bg-slate-950 ">
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent className="grid gap-6">
          <div className="grid grid-cols-3 gap-2">
            ...
            <Button variant="outline"><TelegramIcon className="mr-2 h-4 w-4" /> Telegram</Button>
          </div>
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex justify-between items-center">
                      ...
                      <Link href="#" className="text-sm font-medium text-primary hover:underline">Parolni unutdingizmi?</Link>
                    </div>
                    <div className="relative">
        ...
        <CardFooter className="text-center text-sm">
          <p>Hisobingiz yo'qmi?{" "}
            <Link href="/register" className="font-semibold text-primary hover:underline">Ro'yxatdan o'tish</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
